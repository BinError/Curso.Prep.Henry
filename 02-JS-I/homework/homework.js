...
const nuevaString = 'string comun y silvestre';
...
function resta(x, y) {
  ...
  // Tu código:
  return x - y;
  // Doy por hecho de que los valores de los parametros son numeros
}
...
function esPar(num) {
  ...
  //solucion suponiendo que los valores son enteros
}
